...
{
    wp_enqueue_style('glossary-styles', plugin_dir_url(__FILE__) . 'assets/styles.css', array(), '1.0');
    include_once plugin_dir_path(__FILE__) . 'assets/glossary-plugin.js.php';
}
